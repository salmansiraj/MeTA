...
extension TableRowView {
    ...
    private func makeTitleLabel(text: String?) -> UITextField {
        let label = UITextField()
        label.text = text
        label.placeholder = "Billing Address"
    ...
    private func makeBalanceLabel(text: String?) -> UITextField {
        let balance = UITextField()
        balance.text = text
        balance.textColor = UIColor(red: 0.48, green: 0.48, blue: 0.48, alpha: 1)
        balance.font = UIFont.systemFont(ofSize: 16, weight: .regular)
    ...
    private func makeSubtitleLabel(text: String) -> UITextField {
        let label = UITextField()
        label.textColor = UIColor(red: 0.48, green: 0.48, blue: 0.48, alpha: 1)
        label.font = UIFont.systemFont(ofSize: 16, weight: .regular)
        label.placeholder = "City, State, Zipcode"
