...
extension ExampleView {
    private func makeCookieImage() -> UIImageView {
        let imageView = UIImageView(image: #imageLiteral(resourceName: "TrainImage"))
    ...
    private func makeDescriptionLabel() -> UILabel {
        ...
        textLabel.attributedText = NSMutableAttributedString(string: "Instantly purchase your metrocard \n and stay stress free with MeTA", attributes: attributes)
