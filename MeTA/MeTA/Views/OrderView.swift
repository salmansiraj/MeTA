...
class OrderView : UIView {
    var balance = UserDefaults.standard.string(forKey: "cardBalance")
    ...
    private func commonInit() {
        ...
        stackView.addArrangedSubview(TableRowView(heading: "Info", title: "", subtitle: ""))
        stackView.addArrangedSubview(HairlineView())
        stackView.addArrangedSubview(TableRowView(heading: "Total", title: "$" + balance!, subtitle: nil))
        stackView.addArrangedSubview(HairlineView())
...
extension OrderView {
    private func makeRefundLabel() -> UILabel {
        ...
        label.attributedText = NSMutableAttributedString(string: "You can refund this transaction through contacting your MeTA developers.", attributes: attributes)
